...
zerr = np.array([[0.24, 0.13, 0.43, 0.28, 0.29, 0.22, 0.51, 0.31, 0.52, 0.6, 0.7, 1.1],
                [0.25, 0.16, 0.04, 0.23, 0.35, 0.45, 0.54, 0.30, 0.46, 0.9, 1.2, 1.5]])
...
M_err = np.array([[0.20265029, 0.13033377, 0.32308014, 0.11335686, 0.02679318, 0.1426675,
 0.1836444,  0.18452443, 0.19382003, 0.9765598,  0.20605448, 0.81225782],  # hi values
                  [0.13936845, 0.12221588, 0.17001711, 0.09538349, 0.01168576, 0.08715018,
 0.08297424, 0.13127891, 0.11809931, 0.65890027, 0.14390658, 0.6560418 ]]) # lo values
...
ax.errorbar(z_obs, M_corr, xerr=zerr, yerr=M_err, fmt='o', c='orange', label='Casey24_Bagpipes')
